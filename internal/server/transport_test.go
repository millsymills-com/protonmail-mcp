...
func TestTransportConfigFromEnv(t *testing.T) {
	tests := []struct {
		...
		{name: "default stdio", env: nil, want: transportConfig{kind: "stdio"}},
		{
			...
			env:  map[string]string{"PROTONMAIL_MCP_TRANSPORT": "sse", "PROTONMAIL_MCP_PORT": "8770", "PROTONMAIL_MCP_SSE_TOKEN": "0123456789abcdef0"},
			want: transportConfig{kind: "sse", host: "127.0.0.1", port: 8770, token: "0123456789abcdef0"},
		},
		{
			name: "sse custom host",
			env:  map[string]string{"PROTONMAIL_MCP_TRANSPORT": "sse", "PROTONMAIL_MCP_HOST": "0.0.0.0", "PROTONMAIL_MCP_PORT": "9000", "PROTONMAIL_MCP_SSE_TOKEN": "0123456789abcdef0"},
			want: transportConfig{kind: "sse", host: "0.0.0.0", port: 9000, token: "0123456789abcdef0"},
		},
		...
		{name: "sse short token", env: map[string]string{"PROTONMAIL_MCP_TRANSPORT": "sse", "PROTONMAIL_MCP_PORT": "8770", "PROTONMAIL_MCP_SSE_TOKEN": "tooshort"}, wantErr: "at least 16 characters"},
