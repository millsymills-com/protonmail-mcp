...
Tools: 32 total — 16 read, 15 write, 1 dangerous.
...
| `proton_delete_address` | write | `WRITES` | `id*`:string | `ok*`:boolean |
...
| `proton_remove_custom_domain` | write | `WRITES` | `id*`:string | `ok*`:boolean |
